...
use mirrorlist_server::treebitmap::*;
...
fn exact_match_mut() {
    let mut tbm = IpLookupTable::new();
    tbm.insert(Ipv4Addr::new(10, 0, 0, 0), 8, 1);
    tbm.insert(Ipv4Addr::new(100, 64, 0, 0), 24, 2);

    if let Some(value) = tbm.exact_match_mut(Ipv4Addr::new(10, 0, 0, 0), 8) {
        *value = 100;
    }

    let result = tbm.exact_match(Ipv4Addr::new(10, 0, 0, 0), 8);
    assert_eq!(result, Some(&100));
}

#[test]
fn longest_match_mut() {
    let mut tbm = IpLookupTable::new();
    tbm.insert(Ipv4Addr::new(10, 0, 0, 0), 8, 1);
    tbm.insert(Ipv4Addr::new(100, 64, 0, 0), 24, 2);

    if let Some((_, _, value)) = tbm.longest_match_mut(Ipv4Addr::new(10, 10, 10, 10)) {
        *value = 100;
    }

    let result = tbm.longest_match(Ipv4Addr::new(10, 10, 10, 10));
    assert_eq!(result, Some((Ipv4Addr::new(10, 0, 0, 0), 8, &100)));
}
...
fn matches() {
    let mut tbm = IpLookupTable::new();
    tbm.insert(Ipv4Addr::new(10, 0, 0, 0), 8, 1);
    tbm.insert(Ipv4Addr::new(10, 10, 0, 0), 16, 2);
    tbm.insert(Ipv4Addr::new(10, 10, 10, 0), 24, 3);
    tbm.insert(Ipv4Addr::new(100, 64, 0, 0), 24, 4);

    let matches: Vec<_> = tbm.matches(Ipv4Addr::new(10, 10, 10, 10)).collect();
    assert_eq!(matches.len(), 3);
    assert_eq!(matches[0], (Ipv4Addr::new(10, 0, 0, 0), 8, &1));
    assert_eq!(matches[1], (Ipv4Addr::new(10, 10, 0, 0), 16, &2));
    assert_eq!(matches[2], (Ipv4Addr::new(10, 10, 10, 0), 24, &3));

    let matches: Vec<_> = tbm.matches(Ipv4Addr::new(10, 10, 20, 10)).collect();
    assert_eq!(matches.len(), 2);
    assert_eq!(matches[0], (Ipv4Addr::new(10, 0, 0, 0), 8, &1));
    assert_eq!(matches[1], (Ipv4Addr::new(10, 10, 0, 0), 16, &2));

    let matches: Vec<_> = tbm.matches(Ipv4Addr::new(200, 200, 200, 200)).collect();
...
fn matches_mut() {
    ...
    for (_, _, value) in tbm.matches_mut(Ipv4Addr::new(10, 10, 10, 10)) {
        *value += 10;
    }

    let matches: Vec<_> = tbm.matches(Ipv4Addr::new(10, 10, 10, 10)).collect();
    assert_eq!(matches[0], (Ipv4Addr::new(10, 0, 0, 0), 8, &11));
    assert_eq!(matches[1], (Ipv4Addr::new(10, 10, 0, 0), 16, &12));
    assert_eq!(matches[2], (Ipv4Addr::new(10, 10, 10, 0), 24, &13));
}
